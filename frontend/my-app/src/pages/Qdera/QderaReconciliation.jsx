...
import { fetchQderaStats, fetchQderaClients } from '../../api/queries';
...
import './QderaReconciliation.css';
...
const QderaReconciliation = () => {
    ...
    // ── Queries ──
    const { data: qderaClients } = useQuery({
        queryKey: ['qderaClients'],
        queryFn: fetchQderaClients,
    });

    const { data: stats, isLoading, error, isFetching } = useQuery({
        queryKey: ['qderaStats', appliedFilters],
        queryFn: () => fetchQderaStats(appliedFilters),
        staleTime: 30000,
        enabled: !!(
            filterType === 'all' ||
    ...
    const totalQderaCount = stats?.totalQderaCount || 0;
    ...
    const COLORS = ['#f59e0b', '#ef4444', '#10b981', '#3b82f6', '#8b5cf6', '#06b6d4', '#ec4899', '#14b8a6'];
    ...
    return (
        <div className="qdera-page">
            {/* ───── FILTER PANEL ───── */}
            <div className="qdera-filter">
                <div className="filter-header">
                    <Layers size={20} />
                    <h3>Qdera vs LZ Filters</h3>
            ...
            {isFetching && !showInitialLoading && (
                <div className="loading-bar-container">
                    ...
                    <span className="loading-bar-text">Loading Qdera reconciliation data...</span>
                </div>
            )}
            ...
            {showInitialLoading && (
                <div className="loading-section">
                    ...
                    <p>Loading Qdera reconciliation data...</p>
                </div>
            )}
            ...
            <div className="stats-grid">
                ...
                <div className="stat-card">
                    <div className="stat-icon orange"><Database size={24} /></div>
                    <div className="stat-content">
                        <h3>{totalQderaCount.toLocaleString()}</h3>
                        <p>Qdera Transactions</p>
                    </div>
                </div>
                <div className="stat-card">
                            ...
                            <div key={client.prefix} className="client-tile">
                                ...
                                <div className="client-tile-stats">
                                    <div className="client-stat info">
                                        <div className="stat-label"><Database size={16} /><span>Qdera Count</span></div>
                                        <div className="stat-values">
                                            <span className="count">{client.totalQderaCount.toLocaleString()}</span>
                                        </div>
                                    </div>
                                    <div className="client-stat info">
            ...
            <div className="charts-grid">
                ...
                {/* Grouped bar: Qdera vs LZ per client */}
                <div className="chart-card chart-card-wide">
                    <div className="chart-header">
                        <h3>Qdera vs LZ by Client</h3>
                    ...
                    <ResponsiveContainer width="100%" height={300}>
                        <BarChart data={reconciliationByClient}>
                            ...
                            <Legend />
                            <Bar dataKey="qderaCount" name="Qdera Count" fill="#f59e0b" radius={[6, 6, 0, 0]} />
                                        ...
                                        <div className="tree-run-details">
                                            <div className="detail-table-wrapper">
                                                <table className="detail-table compact">
                                                    ...
                                                    <tbody>
                                                        {rows.map((row, ri) => {
                                                            const diff = (row.lz_count || 0) - (row.qdera_count || 0);
                                                            return (
                                                                <tr key={ri}>
                                                                    ...
                                                                    <td className="num">{(row.qdera_count || 0).toLocaleString()}</td>
...
export default QderaReconciliation;
